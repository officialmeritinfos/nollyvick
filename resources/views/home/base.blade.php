...
<body class="body-wrapper">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a
                                                        href="{{route('service.details',['id'=>$service->id])}}">{{$service->title}}</a>
                                                </li>
                                                @endforeach
                                            </ul>
                                        </li>
                ...
                <div class="consulter-mobile-nav">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                @foreach($injected->getServices() as $service)
                                <li><a href="{{route('service.details',['id'=>$service->id])}}">{{$service->title}}</a>
                                </li>
                                @endforeach
                            </ul>
                        </li>
    ...
    <footer class="footer-1 footer-2 overflow-hidden"
        style="background-image: url({{asset('home/img/footer/footer-bg-2.png')}});">
